...
// перевод из структуры в класс для сохранение своего типа данных в юзер дефолтс
class SearchViewModel: NSObject, NSCoding {
    ...
    @objc(_TtCC9Music_App15SearchViewModel4Cell)class Cell: NSObject, NSCoding, Identifiable {
